var cvjs_stickyNotesRedlines_Base = {
					...
					1: {
						...
						userid: "user_1",
						currentPage: 2,
						date: "Wed Aug 18 2021 14:09:43 GMT+0200 (centraleuropeisk sommartid)",
						linked: true,
						transform: "T1571.4926764199656,589.6066265060241S3.345",
						drawingRotation: 0
					}
}
...
var cItemRed1= paper.path("M532.8154819277108,493.9776247848537h376.5283993115318v749.6024096385541h-376.5283993115318v-749.6024096385541 Z ").attr({stroke: "#FF0000", "stroke-width": "4", "fill": "#FF0000", "fill-opacity": "0.1"})
.data("node","RED_1");
